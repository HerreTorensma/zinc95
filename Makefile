...
SRC = src/main.c src/backend/backend.c src/backend/sdl2.c src/computer.c src/util/util.c src/api/api.c src/editors/sprite.c src/backend/input.c src/res.c
OBJ = $(SRC:.c = .o)
